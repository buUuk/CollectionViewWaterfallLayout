...
public class CollectionViewWaterfallLayout: UICollectionViewLayout {
    ...
    public var columnCount:Int = 2 {
        didSet {
            invalidateIfNotEqual(oldValue: NSNumber(value:oldValue), newValue: NSNumber(value:columnCount))
        }
    }
    public var minimumColumnSpacing:Float = 10.0 {
        didSet {
            invalidateIfNotEqual(oldValue: NSNumber(value:oldValue), newValue: NSNumber(value: minimumColumnSpacing))
        }
    }
    public var minimumInteritemSpacing:Float = 10.0 {
        didSet {
            invalidateIfNotEqual(oldValue: NSNumber(value:oldValue), newValue: NSNumber(value: minimumInteritemSpacing))
        }
    }
    public var headerHeight:Float = 0.0 {
        didSet {
            invalidateIfNotEqual(oldValue: NSNumber(value:oldValue), newValue: NSNumber(value: headerHeight))
        }
    }
    public var footerHeight:Float = 0.0 {
        didSet {
            invalidateIfNotEqual(oldValue: NSNumber(value:oldValue), newValue: NSNumber(value: footerHeight))
        }
    }
